...
(asyncErrorHandler(async () => {
    try {
        ...
        if (!import.meta.env.VITE_DEV_API_KEY || !import.meta.env.VITE_DEV_SECRET_KEY || !import.meta.env.VITE_DEV_SECRET_VALUE) {
            console.warn('Environment variables not found, using default values');
            // Use default values from .env file
            const apiUrl = atob("aHR0cHM6Ly9hcGkubnBvaW50LmlvLzE0ODk4NDcyOWUxMzg0Y2JlMjEy");
